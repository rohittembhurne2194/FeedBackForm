    ...
    $('select').on('change', function () {
        ...
        if (this.value == 2) {
           // alert("Marathi");
            ...
            $("#que_five").text("5. सर्व शौचालये/मुताऱ्या स्वच्छ आणि वापरण्यायोग्य आहेत:");
            $("#que_six").text("6. हात धुण्याकरिता वॉश बेसिन स्वच्छ व वापरण्यायोग्य आहेत:");
            $("#que_seven").text("7. सर्व शौचालये/मुताऱ्याांमध्ये हवा खेळती राहील अशी व्यर्स्था आहे:");
            $("#que_eight").text("8. प्रत्येक शॉचालायात दारे बंद  करण्याकरीत कड्या सुस्थितीत आहेत :");
            $("#que_nine").text("9. शौचालयाचा मजला नेहमी कोरड्या आणि स्वच्छ असतो:");
            $("#que_ten").text("10. हात धुण्याकरिता साबण व डिस्पेन्सर उपलब्ध आहेत:");
            $("#que_eleven").text("11. महिला शौचालयाांमध्ये सॅनिटरी  नॅपकिन व्हेंडिंग  मशीन उपलब्ध आहेत:");
        ...
        if (this.value == 3) {
            ...
            $("#que_five").text("5. सभी शौचालय सीटें और मूत्रालय हर समय साफ और प्रयोग करने योग्य हैं:");
            $("#que_six").text("6. वॉश बेसिन (ओं) / हाथ धोने की सुविधा हर समय साफ और प्रयोग करने योग्य:");
            $("#que_seven").text("7. पर्याप्त वेंटिलेशन सुविधा:");
            $("#que_eight").text("8. सभी शौचालय सीटों के सभी दरवाजों पर कार्यात्मक बोल्टिंग व्यवस्था:");
            $("#que_nine").text("9. शौचालय का फर्श हर समय सूखा और साफ रहता है:");
            $("#que_ten").text("10. उपलब्ध साबुन / परिचालन साबुन डिस्पेंसर:");
            $("#que_eleven").text("11. महिला शौचालयों में सैनिटरी नैपकिन के लिए वेंडिंग मशीन/तंत्र है:");
