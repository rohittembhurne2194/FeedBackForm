<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Advance_GoogleHit.aspx.cs" Inherits="feedbackform.Advance_GoogleHit" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <title>Advance GoogleHit</title>
     <meta charset="utf-8"/>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="table-responsive">
            ...
            <asp:GridView ID="Advance_Grdgooglehit" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" 
              AllowPaging="true" OnPageIndexChanging="Advance_Grdgooglehit_PageIndexChanging">
                    <Columns>
